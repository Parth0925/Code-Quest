...
export const createAnswerNotification = async (userId, questionId) => {
    const notification = new Notification({
      userId,
      type: 'answer',
      message: `Someone has answered your question #${questionId}.`,
    });
    await notification.save();
    io.emit('answer', { message: `Someone answered your question #${questionId}!` });
  };